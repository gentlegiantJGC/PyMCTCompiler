...
_J19 = NBTRemapHelper(
    [
        (
            ("Text1", "string", []),
            (0, "string", [("utags", "compound"), ("front_text", "compound"), ("messages", "list")])
        ),
        (
            ("Text2", "string", []),
            (1, "string", [("utags", "compound"), ("front_text", "compound"), ("messages", "list")])
        ),
        (
            ("Text3", "string", []),
            (2, "string", [("utags", "compound"), ("front_text", "compound"), ("messages", "list")])
        ),
        (
            ("Text4", "string", []),
            (3, "string", [("utags", "compound"), ("front_text", "compound"), ("messages", "list")])
        )
    ],
...
_J120 = NBTRemapHelper(
    [
        (
            ("is_waxed", "byte", []),
            ("is_waxed", "byte", [("utags", "compound")])
        ),
        (
            ("has_glowing_text", "byte", [("front_text", "compound")]),
            ("has_glowing_text", "byte", [("utags", "compound"), ("front_text", "compound")])
        ),
        (
        ...
        (
            ...
            ("has_glowing_text", "byte", [("utags", "compound"), ("back_text", "compound")])
        ),
        (
        ...
        (
            ...
            (0, "string", [("utags", "compound"), ("back_text", "compound"), ("messages", "list")])
        ),
        (
            (1, "string", [("back_text", "compound"), ("messages", "list")]),
            (1, "string", [("utags", "compound"), ("back_text", "compound"), ("messages", "list")])
        ),
        (
            (2, "string", [("back_text", "compound"), ("messages", "list")]),
            (2, "string", [("utags", "compound"), ("back_text", "compound"), ("messages", "list")])
        ),
        (
            (3, "string", [("back_text", "compound"), ("messages", "list")]),
            (3, "string", [("utags", "compound"), ("back_text", "compound"), ("messages", "list")])
        )
    ],
    '{back_text: {has_glowing_text: 0b, color: "black", messages: ["{\\"text\\":\\"\\"}", "{\\"text\\":\\"\\"}", "{\\"text\\":\\"\\"}", "{\\"text\\":\\"\\"}"]}, is_waxed: 0b, front_text: {has_glowing_text: 0b, color: "black", messages: ["{\\"text\\":\\"\\"}", "{\\"text\\":\\"\\"}", "{\\"text\\":\\"\\"}", "{\\"text\\":\\"\\"}"]}}'
)
...
_B17 = NBTRemapHelper(
    [
        (
            ("TextOwner", "string", []),
            ("TextOwner", "string", [("utags", "compound"), ("front_text", "compound")])
        ),
        (
            ("Text", "string", []),
            (None, None, None)
...
_B120 = NBTRemapHelper(
    [
        ...
        (
            ...
            ("IgnoreLighting", "byte", [("utags", "compound"), ("front_text", "compound")])
        ),
        (
            ("PersistFormatting", "byte", [("FrontText", "compound")]),
            ("PersistFormatting", "byte", [("utags", "compound"), ("front_text", "compound")])
        ),
        (
            ("SignTextColor", "int", [("FrontText", "compound")]),
            ("SignTextColor", "int", [("utags", "compound"), ("front_text", "compound")])
        ),
        (
            ("Text", "string", [("FrontText", "compound")]),
            (None, None, None)
        ),
        (
        ...
        (
            ...
            ("IgnoreLighting", "byte", [("utags", "compound"), ("back_text", "compound")])
        ),
        (
            ("PersistFormatting", "byte", [("BackText", "compound")]),
            ("PersistFormatting", "byte", [("utags", "compound"), ("back_text", "compound")])
        ),
        (
            ("SignTextColor", "int", [("BackText", "compound")]),
            ("SignTextColor", "int", [("utags", "compound"), ("back_text", "compound")])
        ),
        (
            ("Text", "string", [("BackText", "compound")]),
            (None, None, None)
        ),
        (

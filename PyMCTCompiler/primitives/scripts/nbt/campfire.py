...
_B111 = NBTRemapHelper(
    [
        ...
        (("Item1", "compound", []), ("Item1", "compound", [("utags", "compound")])),
        (("Item2", "compound", []), ("Item2", "compound", [("utags", "compound")])),
        (("Item3", "compound", []), ("Item3", "compound", [("utags", "compound")])),
        (("Item4", "compound", []), ("Item4", "compound", [("utags", "compound")])),
    ],
...
b113 = merge(
    [EmptyNBT(":Campfire"), _B111, bedrock_is_movable], ["universal_minecraft:campfire"]
)

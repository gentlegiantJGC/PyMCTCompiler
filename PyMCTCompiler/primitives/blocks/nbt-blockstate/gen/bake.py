...
property_name_remap = {
    ...
    "damage": [
        ...
        {
            "undamaged": "normal",
            "slightly_damaged": "chipped",
            "very_damaged": "damaged",
            "broken": "broken",
        },
    ],
    ...
    "flower_type": [
        "type",
        {"orchid": "blue_orchid", "houstonia": "azure_bluet", "oxeye": "oxeye_daisy"},
    ],
...
for blockstate in block_palette["blocks"]:
    ...
    if (namespace, base_name) not in blocks:
        blocks[(namespace, base_name)] = {
            "properties": {
                prop["name"]: [
                    [to_snbt(prop["type"], prop["value"]), str(prop["value"])]
                ]
        ...
        primitive = {
            ...
            "from_universal": {
                f"universal_{namespace}:{base_name}": [
                    {"function": "new_block", "options": f"{namespace}:{base_name}"}
                ]
            },
        }

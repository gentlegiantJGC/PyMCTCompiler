...
property_name_remap = {
	...
	'ground_sign_direction': ['rotation', None],
	'growth': ['age', None],
	...
	'liquid_depth': ['level', {}],
	'moisturized_amount': ['moisture', None],
	...
	'new_leaf_type': ['material', None],
	'new_log_type': ['material', None],
	'no_drop_bit': ['drop_item', {"0": "true", "1": "false"}],
	'occupied_bit': ['occupied', bool_map],
	'old_leaf_type': ['material', None],
	'old_log_type': ['material', None],
	...
	'prismarine_block_type': ['variant', None],
	...
	'redstone_signal': ['power', None],
	'repeater_delay': ['delay', None],
	...
	'stone_slab_type_3': ['material', None],
	'stone_slab_type_4': ['material', None],
	'stone_type': ['stone_type', {}],
	'stripped_bit': ['stripped', bool_map],
	'structure_block_type': ['mode', None],

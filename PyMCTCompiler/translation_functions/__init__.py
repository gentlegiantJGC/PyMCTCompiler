...
from .base_translation_function import BaseTranslationObject, BaseTranslationFunction, FunctionList

extend_feature_set = {
	'walk_input_nbt': [CarryNBT.function_name, MapNBT.function_name]
}
